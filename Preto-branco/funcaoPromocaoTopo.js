...
corTopo = '#0d0c0c';
    ...
    promocao_topo = '<span class="devrocket-barra-oferta"> FRETE GRÁTIS PARA COMPRAS ACIMA DE <strong>R$ 150,00</strong> </span>';
...
$(function() {
        funcaoPromocaoTopo()
		console.log('funcaoPromocaoTopo')
    });